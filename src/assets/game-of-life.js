...
(function () {
  ...
  function waitForStyles() {
    return new Promise((resolve) => {
      ...
      function checkStyles() {
        ...
        // If CSS variables are available and not empty, proceed
        if (bgColor && bgColor !== '') {
          resolve();
        } else {
          // Wait a bit longer
      ...
      // Start checking after a brief delay to ensure CSS is parsing
      requestAnimationFrame(checkStyles);
    });
  }
  ...
  function initGameOfLife() {
    ...
    function getThemeColors(){
      ...
      // In light mode alive should be black (#000), bg white (#fff). In dark invert.
